...
<link
	rel="stylesheet"
	href="${pageContext.request.contextPath}/css/addRoom.css" />
</head>
<body>
	...
	<div class="add-rooms">
		<div class="header">
			<h2>Manage Rooms</h2>
			<a
				href="${pageContext.request.contextPath}/admin/manageRooms.jsp"
			...
			<div class="form-container">
				<div class="form-row">
					<div class="form-fields">
						<label
							for="roomNumber"
							class="label-for-form">Room Number:</label> <input
							type="text"
					...
					<div class="form-fields">
						<label
							for="roomType"
							class="label-for-form">Room Type:</label> <select
							...
							<option
								value="suite"
								${param.roomType == 'suite' ? 'selected' : ''}>Suite</option>
							<option
								value="deluxe"
								${param.roomType == 'deluxe' ? 'selected' : ''}>Deluxe</option>
						</select>
				...
				<div class="form-row">
					<div class="form-fields">
						<label
							for="noOfBeds"
							class="label-for-form">Number of Beds:</label> <input
							type="text"
					...
					<div class="form-fields">
						<label
							for="bedType"
							class="label-for-form">Bed Type:</label> <select
				...
				<div class="form-row">
					<div class="form-fields">
						<label
							for="price"
							class="label-for-form">Price Per Night (Rs.):</label> <input
							type="text"
					...
					<div class="form-fields">
						<label
							for="roomArea"
							class="label-for-form">Room Area:</label> <input
							type="text"
				...
				<div class="form-row">
					<div class="form-fields">
						<label
							for="roomImage"
							class="label-for-form">Room Image:</label> <input
							type="file"
							id="roomImage"
							class="form-control"
							name="roomImage"
					...
					<div class="form-fields">
						<label
							for="description"
							class="label-for-form">Description:</label>
						<textarea
							id="description"
							name="description"
