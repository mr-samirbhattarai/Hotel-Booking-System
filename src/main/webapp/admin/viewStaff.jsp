		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<a
					href="${pageContext.request.contextPath}/ManageEmployeeController?action=delete&user_id=<%= user.getUserId() %>"
			...
			<!-- Edit Modal -->
			<div class="modal fade" id="editModal<%=user.getUserId()%>"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form
							action="${pageContext.request.contextPath}/ManageEmployeeController"
							method="post">
							<div class="modal-body">
								...
								<div class="form-group">
									<label for="dob">DOB</label> <input type="date"
										class="form-control" name="dob" value="<%=user.getDob()%>"
										required>
								</div>
								<div class="form-group">
